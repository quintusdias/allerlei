...
\section{Computer skills}
  \cvcomputer{Programming}{Strong in Python e.g. numpy, pandas, matplotlib.
      Several years experience with MATLAB, C/C++, Bash.
      Familiar with R, SAS, \LaTeX, SQL, XMP/XML.  Past
      experience with Java, PHP, Perl, Fortran 77/90}
  \cvcomputer{Software Practices}{Experience with continuous integration,
    writing test plans, unit testing, and software
  ...
  \cvcomputer{Platforms and Systems \mbox{Administration}}{Familiar with
    administering Linux Mint / Ubuntu, openSUSE, and Mac OS X.
    Past experience with Fedora, CentOS, Mandriva, Scyld, Red Hat,
    Digital Unix, Irix, Windows. }
