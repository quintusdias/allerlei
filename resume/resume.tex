...
\address{1903 Duffield Lane}{Alexandria, VA  22307}{USA}
...
\cvitem{}
{    
    Secure a position in Linux systems administration.
}
...
{
    {\textbf{RHCSA:  Red Hat Certified System Administrator}}: granted 2020-07-10.
...
\cvcomputer{System Administration}
{
    ...
    Familiar with PostgreSQL, Nagios, ArcGIS Server.
    Some experience with Duplicity, GeoServer, MySQL, JMeter.
}
...
{
    RHCSA certified through July 2023.  Most work experience on RHEL 6/7/8.
    Some experience with Debian, Ubuntu, Scyld, Digital Unix, and Irix.
    Past experience configuring Samba, Amanda, Apache, iptables, FLEXLM.
}
...
\cvlistitem
{
    ...
    Tools for accessing JPEG 2000 files.
}
\cvlistitem
{
...
\cvlistitem
{
    \href{http://python-xmp-toolkit.readthedocs.org}{\texttt{Python XMP Toolkit}}:
    a package interfacing with the exempi library for reading and writing
    XMP metadata.
}
\cvlistitem{
