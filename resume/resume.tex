...
{
	Experience administering Nagios on Debian.  Familiar with
	ArcGIS and PostgreSQL server environments.  Some experience
	administering MySQL.	  Familiar with JMeter.
}
\cvcomputer{Languages Platforms}
{
    Python - experience with numpy, pandas, matplotlib, seaborn, jupyter notebooks, requests, unittest, asyncio, psycopg2, lxml, requests.  Several years experience with MATLAB, C/C++, Bash, and writing scripts for Big Brother.  Past experience with \LaTeX, Java, PHP, Perl, Fortran 77/90.  Some experience with Oracle, jQuery, R, SAS, Geoserver.
}
\cvcomputer{Software Practices}
{
Experience with continuous integration, writing test plans, unit testing, and software version control packages such as Git, Subversion, Perforce, and CVS.
}
\cvcomputer{Linux Systems}
{
RHCSA certified through July 2023.  Most work experience on RHEL 6/7.
