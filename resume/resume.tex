...
\cvcomputer{Languages}{
    Strong in Python (numpy, pandas, matplotlib, unittest, bokeh).  Client-side
	experience with PostgreSQL (psql, psycopg2).  Several
    years experience with MATLAB, C/C++, Bash.  Familiar with R,
    jQuery, SAS, \LaTeX.  Past experience with jQuery, SAS, Java,
	PHP, Perl, Fortran 77/90, database administration with MySQL.  Some
	experience with Oracle, SQLite.}
...
\cvcomputer{Platforms and Systems \mbox{Administration}}{Currently
    working with RHEL 7, Fedora, and Mac OS X.  Past experience
    configuring Mandriva, Scyld, Ubuntu, Digital Unix, Irix,
...
\cvlistitem{Python XMP Toolkit:
    ...
    {\texttt{http://python-xmp-toolkit.readthedocs.org}}}
\cvlistitem{Mexcdf:
