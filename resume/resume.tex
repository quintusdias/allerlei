...
{
    Strong in Python
	(numpy, pandas, lxml, requests, matplotlib, unittest, psycopg2).
...
{UCAR}{Washington, DC}{}
{
	...
	review prior 24 hours operations.  Wrote custom scripts for
	collection of realtime operational metrics, analysis of web
	logs, running load tests with JMeter.  Created ISO 19115-2
	metadata records with custom Python scripts for over 60 web
	mapping services.  }
\cventry
{2014 -- 2015}
{Programmer}
