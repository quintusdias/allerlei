...
\address{3825 NE 155th PL}{Lake Forest Park, WA  98155}{USA}
...
\cvcomputer{Languages and Platforms}
{
    ...
    jupyter notebooks, requests, unittest, asyncio, psycopg2, lxml, requests.
...
{
	Rewrite MAPCO2 buoy data processing system from VBA/Excel to
	Python and netCDF.
}
\cventry
{May 2019 -- Dec 2019}
...
{
    Development of Python tools to facilitate validation of XML metadata
    for inclusion in DataOne (https://dataone.org).  This supports our
    partner organizations such as the NorthWest Knowledge Network, the
    Atmospheric Radiation and Measurement (ARM) group at Oak Ridge, and
