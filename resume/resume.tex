...
{
    Experienced with CentOS 7, Debian 8.  Experienced administering Nagios.
    Familiar with ArcGIS and PostgreSQL server environments.
    Some experience administering MySQL.  Familiar with JMeter.
    Some familiary with Confluence, Jira, Duplicity.
...
{
Experience with continuous integration, writing test plans, unit testing,
and software version control packages such as Git, Mercurial, Subversion,
Perforce, and CVS.
}
