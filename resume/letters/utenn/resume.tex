...
{Cyberdata}{Washington, DC}{}
	...
	24/7 operational support and monitoring of applications within IDP (Integrated Dissemination Program) at NOAA, including nowCOAST (https://nowcoast.noaa.gov) and  IDP-GIS (https://idpgis.ncep.noaa.gov).  System administration of ArcGIS server farms.  Daily participation at NCEP Central Operations "OPS" meetings to review prior 24 hours operations.  Wrote tools for analysis of web logs, running load tests with JMeter, and Big Brother scripts for realtime monitoring of operations, including test suites. 
\cventry
{May 2015 -- Aug 2018}
{Software Engineer}
{UCAR}{Washington, DC}{}
