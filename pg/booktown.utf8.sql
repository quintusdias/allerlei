...
CREATE FUNCTION "plpgsql_call_handler" () RETURNS opaque AS '/usr/lib/postgresql/9.3/lib/plpgsql.so', 'plpgsql_call_handler' LANGUAGE 'c';
...
CREATE FUNCTION "you_me" (user_no integer) RETURNS integer AS '
  DECLARE
   --RENAME $1 TO user_no;
    --you INTEGER := 5;
  BEGIN
...
-- Move to above dist_cust function
